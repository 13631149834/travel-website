  ...
  const RitualCelebration = {
    ...
    show(achievement) {
      ...
      style.textContent = `
        ...
        .ritual-content { position: relative; background: linear-gradient(135deg, #FFF3E0, #FFE0B2); border-radius: 24px; padding: 40px 32px; max-width: 340px; width: 90%; text-align: center; box-shadow: 0 20px 60px rgba(230,81,0,0.3); animation: ritualPop 0.5s ease; }
        ...
        .ritual-badge { display: inline-flex; align-items: center; gap: 6px; background: #E65100; color: #FFF; padding: 6px 16px; border-radius: 20px; font-size: 0.8rem; font-weight: 600; margin-bottom: 12px; }
        ...
        .ritual-close-btn { width: 100%; padding: 12px; background: #FFF; color: #E65100; border: 2px solid #E65100; border-radius: 25px; font-size: 0.9rem; font-weight: 600; cursor: pointer; }
      `;
